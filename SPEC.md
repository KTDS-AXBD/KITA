...
| F016 | S6 P0 조회 정식화 + 검증 ✅ — 공용 SQL 빌더(정형·그래프 재귀CTE·FTS5 entity_fts) 빌드·Worker 공유 + 읽기전용 `/api/givc/*` 3종(하이브리드) + vitest 14(총 23) + 실모드 검증(콘솔에러0·실기업6사) + 성능 실측(첫로딩 97ms·S4 재계산 0.17ms) | KITA-REQ-016 | P0 | S6 | ✅ |
