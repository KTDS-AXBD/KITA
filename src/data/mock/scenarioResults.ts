...
export const CQ2_TOP5_COMPANIES: CompanyCandidate[] = [
  { rank: 1, name: '대한정밀감속기', sub: '하모닉 드라이브 · 정밀 감속기 · 경남 창원', type: '핵심', rnd: '26.0%', sales: '19.0%', patent: '44건', risk: '1.7%', score: 0.69 },
  { rank: 2, name: '한일서보모션', sub: '서보모터 · 모션 컨트롤러 · 경기 안산', type: '핵심', rnd: '30.0%', sales: '16.0%', patent: '49건', risk: '1.5%', score: 0.67 },
  { rank: 3, name: '미래기계소재', sub: '메어링칭 · 공구홀더 · 충남 천안', type: '예비', rnd: '25.0%', sales: '12.0%', patent: '26건', risk: '2.2%', score: 0.52 },
  { rank: 4, name: '대전유압', sub: '고압 유압밸브 · 실린더 · 대전', type: '핵심', rnd: '20.0%', sales: '13.0%', patent: '31건', risk: '2.4%', score: 0.52 },
  { rank: 5, name: '서원베어링테크', sub: '정밀 볼 · 롤러 베어링 · 경북 경주', type: '핵심', rnd: '18.0%', sales: '12.0%', patent: '36건', risk: '2.1%', score: 0.51 },
];

// CQ-002 의존 구조
export const DEPENDENCY_ITEMS = [
  { name: '정밀감속기', pct: 85, country: '일본', bg: '#111' },
  { name: '볼스크류', pct: 75, country: '일본', bg: '#333' },
  { name: '서보모터', pct: 72, country: '일본', bg: '#555' },
  { name: '리니어가이드', pct: 71, country: '일본', bg: '#777' },
  { name: '정밀베어링', pct: 68, country: '일본', bg: '#999' },
];
...
export const RND_CASES: RnDCase[] = [
  { year: '2023', title: '로봇용 정밀 감속기(하모닉 드라이브) 국산화', org: '산업기술평가관리원 · 5.2억 · 특허 14건 / 일반 전환', matchRate: 87 },
  { year: '2022', title: '고하중 정밀 베어링 수입대체 공정', org: '한국산업기술진흥원 · 3.8억 · 소부장 강소기업 지정', matchRate: 79 },
  { year: '2024', title: '서보모터·모션제어 자립화', org: '산업기술평가관리원 · 5.8억 · 진행 중 (Phase 2)', matchRate: 72 },
];
...
export const CQ1_TOP5_ITEMS: ImpactItem[] = [
  { rank: 1, name: 'PE (폴리에틸렌)', hs: '3901', industry: '석유화학', score: 94.2, scoreColor: '#111', duration: '즉시~1주', path: '원유→나프타(72.3%)→에틸렌(45.2%)→PE(35.2%)', evidence: '투입계수 누적 11.4%, 중동 의존도 63.7%' },
  { rank: 2, name: 'PP (폴리프로필렌)', hs: '3902', industry: '석유화학', score: 87.6, scoreColor: '#111', duration: '즉시~1주', path: '원유→나프타→프로필렌(28.1%)→PP(42.1%)', evidence: '투입계수 누적 8.5%, 자동차 핵심소재' },
  { rank: 3, name: '합성고무', hs: '4002', industry: '자동차', score: 72.3, scoreColor: '#444', duration: '1~2주', path: '원유→나프타→프로필렌→합성고무(15.4%)', evidence: '타이어 산업 직접 영향, 대체재 제한' },
  { rank: 4, name: 'EG (에틸렌글리콜)', hs: '2905.31', industry: '섬유', score: 65.8, scoreColor: '#444', duration: '1~3주', path: '원유→나프타→에틸렌→EG(12.8%)', evidence: '폴리에스터 원료, 중국 수입 대안 존재' },
  { rank: 5, name: 'SM (스티렌모노머)', hs: '2902.50', industry: '건설', score: 58.4, scoreColor: '#777', duration: '2~4주', path: '원유→나프타→에틸렌→SM(8.5%)', evidence: 'PS/ABS 원료, 건설/포장재 영향' },
];
