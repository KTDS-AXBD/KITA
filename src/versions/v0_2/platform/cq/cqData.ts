...
export const CQ_ITEMS: CqItem[] = [
  {
    ...
    scenarioSid: 'S2',
    customerAsk: "질의서 A·S2 우선순위 + B '품목 -> 품목 전후방 매핑'·'정책 옵션 카드' 제공 의향",
...
ORDER BY impact_score DESC LIMIT 5`,
  ...
  },
  {
    ...
    scenarioSid: 'S4',
    customerAsk: "질의서 A·S4(MAIN) 우선순위 + B '산기평 R&D 공고 이력'·'공작기계 부품 가치사슬' 제공 의향",
...
ORDER BY score DESC LIMIT 5`,
  ...
  },
  {
    ...
    scenarioSid: 'S6',
    customerAsk: "질의서 A·S6 우선순위 + B '공작기계 부품 가치사슬'·'핵심 테이블 컬럼 사전' 제공 의향",
...
ORDER BY alt_volume DESC LIMIT 5`,
  ...
  },
  {
    ...
    scenarioSid: 'S5',
    customerAsk: "질의서 A·S5 우선순위 + B 'EWS 위험 알림 알고리즘 명세'·'정책 옵션 카드' 제공 의향",
...
ORDER BY w.index DESC`,
  ...
  },
  {
    ...
    scenarioSid: 'S4',
    customerAsk: "질의서 A·S4 우선순위 + B '산기평 R&D 공고 이력'·국산화율 데이터 제공 의향",
...
ORDER BY score DESC LIMIT 3`,
  ...
  },
  {
    ...
    scenarioSid: 'S5',
    customerAsk: "질의서 A·S5 우선순위 + B '정책 옵션 카드(과거 정책 이력)'·'산업부 FAQ Top10' 제공 의향",
...
ORDER BY urgency DESC LIMIT 3`,
  ...
  },
  {
    ...
    scenarioSid: 'S6',
    customerAsk: "질의서 A·S6 우선순위 + B 'EWS 위험 알림 알고리즘 명세'·'품목 전후방 매핑' 제공 의향",
