import { Badge, ProvenanceLegend } from '@/components/primitives';
import { ArrowRight, Layers, Database, Sparkles } from '@/components/icons';
import { navigate } from '@/shell';

function MiniS4(): JSX.Element {
  return (
    <svg className="mini-preview" viewBox="0 0 320 120" preserveAspectRatio="xMidYMid meet">
      ...
      <g>
        ...
        <text x="160" y="63" textAnchor="middle" fontSize="9" fontWeight="700" fill="#1F2937">
          R&D
        </text>
    ...
    <svg className="mini-preview" viewBox="0 0 320 120" preserveAspectRatio="xMidYMid meet">
      ...
      <g>
        <circle
          ...
          cy="60"
          r="20"
          fill="var(--axis-color-blue-50)"
          stroke="var(--axis-color-blue-300)"
          strokeWidth="1.5"
        />
        ...
        <text x="60" y="93" textAnchor="middle" fontSize="8" fill="var(--axis-text-secondary)">
          CN
        </text>
        ...
        <circle
          ...
          cy="100"
          r="8"
          fill="var(--axis-color-gray-100)"
          stroke="var(--axis-color-gray-300)"
          strokeDasharray="2 2"
        />
      </g>
    </svg>
...
const PILLARS = [
  {
    ...
    title: 'GIVC 위 온톨로지',
    body:
      'mart.lnk0951a · scmm_his_chart · enp0111y 등 GIVC 12+ 테이블 위에 의미 통일·관계 추론 레이어를 얹어, 단순 검색에서 의사결정 지원으로 가속.',
  },
  {
    icon: Database,
    title: '실 / 추정 / 가상 데이터 혼합',
    body:
      '시연용 가상값은 ※ 점선 박스로 명시. GIVC 실데이터는 ⭐, 추정값은 △. 모든 노드·셀에 출처 tooltip 부착.',
  },
  {
    icon: Sparkles,
    title: '데이터 확장 path 시연',
    body:
      '"현재 → +산기평 공고 → +특허 트렌드 → +전후방"으로 단계별 분석 수준 향상을 우측 영구 패널로 노출.',
  },
];
      ...
      <section>
        ...
        <div className="scenario-grid">
          ...
          >
            ...
            <div className="sc-mini-preview">
              <MiniS4 />
            </div>
            <span className="sc-cta">
              시연 시작 <ArrowRight size={14} />
            </span>
          </a>
          ...
          {PILLARS.map((c, i) => (
            <div
              ...
              style={{
                ...
                borderRadius: 'var(--axis-style-radius-card)',
                padding: 22,
                borderTop: '3px solid var(--axis-color-blue-600)',
              }}
            >
              <c.icon size={20} />
              <div
              ...
              <div
                style={{ fontSize: 12.5, color: 'var(--axis-text-secondary)', lineHeight: 1.65 }}
              >
                {c.body}
              </div>
            </div>
        ...
        >
          <table className="dtable">
            ...
            <tbody>
              <tr>
                <td>
                  <Badge kind="default">Intro</Badge>
                </td>
                <td>Landing</td>
                <td>GIVC 위 온톨로지 레이어 개요</td>
              </tr>
              <tr>
                <td>
                  <Badge kind="info">Main</Badge>
                </td>
                <td>S4 R&D</td>
                <td>R&D 적합 기업 추천 — 가중치 슬라이더 실시간 재계산</td>
              </tr>
              <tr>
                <td>
                  <Badge kind="warning">Hint</Badge>
                </td>
                <td>S4 우측</td>
                <td>산기평 공고 데이터 연동 시 추천 정확도 65→88% 향상</td>
              </tr>
              <tr>
                <td>
              ...
              <tr>
                ...
                <td>S6 우측</td>
                <td>전후방 데이터 연동 시 후방 영향 분석 활성화</td>
              </tr>
              <tr>
                <td>
                  <Badge kind="default">정리</Badge>
                </td>
                <td>About</td>
                <td>데이터 출처·확장 방향</td>
              </tr>
